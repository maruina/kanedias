...
external_url '{{ salt['pillar.get']('gitlab:web:address') }}'
...
gitlab_rails['smtp_port'] = "{{ salt['pillar.get']('gitlab:smtp:port') }}"
gitlab_rails['smtp_user_name'] = "{{ salt['pillar.get']('gitlab:smtp:username') }}"
gitlab_rails['smtp_password'] = "{{ salt['pillar.get']('gitlab:smtp:password') }}"
